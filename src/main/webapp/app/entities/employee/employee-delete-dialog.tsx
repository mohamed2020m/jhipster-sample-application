...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testAppWithJhipsterApp.employee.delete.question">
        <Translate contentKey="testAppWithJhipsterApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
