...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testAppWithJhipsterApp.country.delete.question">
        <Translate contentKey="testAppWithJhipsterApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
