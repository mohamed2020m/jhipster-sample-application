...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testAppWithJhipsterApp.department.delete.question">
        <Translate contentKey="testAppWithJhipsterApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
