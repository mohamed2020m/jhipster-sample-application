    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobHistoryDetailsHeading">
          <Translate contentKey="testAppWithJhipsterApp.jobHistory.detail.title">JobHistory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="testAppWithJhipsterApp.jobHistory.job">Job</Translate>
          </dt>
          ...
          <dt>
            <Translate contentKey="testAppWithJhipsterApp.jobHistory.employee">Employee</Translate>
          </dt>
