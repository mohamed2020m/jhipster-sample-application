...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testAppWithJhipsterApp.jobHistory.delete.question">
        <Translate contentKey="testAppWithJhipsterApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
