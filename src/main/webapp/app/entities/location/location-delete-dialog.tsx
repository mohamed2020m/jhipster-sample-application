...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testAppWithJhipsterApp.location.delete.question">
        <Translate contentKey="testAppWithJhipsterApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
