...
export const RegionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testAppWithJhipsterApp.region.delete.question">
        <Translate contentKey="testAppWithJhipsterApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
